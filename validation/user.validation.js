 ...
 */
export const choiceadd = (req, res, next) => {
  let errors = {},
    reqBody = req.body;  

  if (isEmpty(reqBody.choice)) {
...
export const homeadd = (req, res, next) => {
  let errors = {},
    reqBody = req.body;  
...
export const roleadd = (req, res, next) => {
  ...
  if (isEmpty(reqBody.role)) {
    errors.role = "Role or Professions is required";
  }
...
export const contactformvalidation = (req, res, next) => {
  let errors = {},
    reqBody = req.body;
 
  console.log("fff",req.files)
  // if (isEmpty(req.files.photofile)) {
  //   errors.photofile = "Photofile is required";
  // }
  if (isEmpty(reqBody.name)) {
    errors.name = "Name is required";
  }
  if (isEmpty(reqBody.mail)) {
...
export const logovalidation = (req, res, next) => {
  let errors = {},
    reqBody = req.body;
    // if (isEmpty(reqBody.photofile)) {
    //   errors.files.photofile = "Photofile is required";
    // }
 
  // if (isEmpty(reqBody.image)) {
...
export const bannervalidation = (req, res, next) => {
  let errors = {},
    reqBody = req.body;
 
  
  // if (isEmpty(reqBody.files.photofile)) {
  //   errors.photofile = "Photofile is required";
  // }
...
export const aboutvalidation = (req, res, next) => {
  let errors = {},
    reqBody = req.body;
  ...
  //   errors.photofile = "Photofile is required";
  // }
  if (isEmpty(reqBody.occupation)) {
    errors.occupation = "Content is required";
  }
  if (isEmpty(reqBody.team)) {
    errors.team = "Content is required";
  }
  if (isEmpty(reqBody.name)) {
...
export const industryvalidation = (req, res, next) => {
  let errors = {},
    reqBody = req.body;
...
export const studyvalidation = (req, res, next) => {
  let errors = {},
    reqBody = req.body;
  ...
  if (isEmpty(reqBody.heading)) {
    errors.heading = "Image is required";
  }
  // if (isEmpty(reqBody.photofile)) {
  //   errors.photofile = "Image is required";
  // }
...
export const blogvalidation = (req, res, next) => {
...
export const companyvalidation = (req, res, next) => {
  let errors = {},
    reqBody = req.body;
...
export const testimonialvalidation = (req, res, next) => {
  let errors = {},
    reqBody = req.body;
...
//   if (isEmpty( reqBody.selectedposition)) {
//     errors.Position = "select staff required";
//   }


//   if (isEmpty(reqBody.staff_name)) {
//     errors.Name = " staff name field is required";
//   }

//   if (isEmpty(reqBody.Department_name)) {
//     errors.Department = " Department name field is required";
//   }

//   if (isEmpty(reqBody.staff_id)) {
//     errors.Id = "college id field is required";
//   }


//   if (isEmpty(reqBody.staff_gender)) {
//     errors.Gender = "Gender field is required";
//   }

//   if (isEmpty(reqBody.mobileno)) {
//     errors.Mobile = "mobile field is required";
//   } else if (!mobileRegex.test(reqBody.mobileno)) {
//     errors.Mobile = "Mobile no is invalid";
//   }


//   if (isEmpty(reqBody.selectshift)) {
//     errors.Shift = "shift is required";
//   }

//   if (isEmpty(reqBody.staffmail)) {
//     errors.Mail = "Email field is required";
//   } else if (!emailRegex.test(reqBody.staffmail)) {
//     errors.Mail = "Email is invalid";
//   }

  
//   if (isEmpty(reqBody.staffpassword)) {
//     errors.password = "password field is required";
//   }
//   else if(!passwordRegex.test(reqBody.staffpassword) ){
...
//   else if(confirmpassword !=reqBody.confirmpassword){
//     errors.confirmpassword=  "confirm password field is incorrect"
//   }
